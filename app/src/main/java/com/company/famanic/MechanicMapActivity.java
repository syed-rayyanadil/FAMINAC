...
public class MechanicMapActivity extends FragmentActivity implements OnMapReadyCallback, RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mClientInfo = findViewById(R.id.clientInfo);

        mClientProfileImage = findViewById(R.id.clientProfileImage);

        mClientName = findViewById(R.id.clientName);
        mClientPhone = findViewById(R.id.clientPhone);
        mClientDestination = findViewById(R.id.clientDestination);
        ...
        mServiceStatus = findViewById(R.id.serviceStatus);
        ...
        mHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("Client_OR_Mechanic", "Mechanics");
                startActivity(intent);
                return;
            }
        });
    ...
    private void getAssignedClient(){
        ...
        DatabaseReference assignedClientRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanics").child(clientId).child("clientRequest").child("clientRideId");
    ...
    private void getAssignedClientPickupLocation(){
        assignedClientPickupLocationRef = FirebaseDatabase.getInstance().getReference().child("clientRequest").child(clientId).child("l");
    ...
    private void getAssignedClientDestination(){
        String mechanicId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference assignedClientRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanics").child(mechanicId).child("clientRequest");
    ...
    private void getAssignedClientInfo(){
        ...
        DatabaseReference mClientDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Client").child(clientId);
    ...
    private void endService(){
        mServiceStatus.setText("Service Over");
        erasePolylines();

        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference mechanicRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanic").child(userId).child("clientRequest");
        ...
        mClientDestination.setText("Destination: --");
        mClientProfileImage.setImageResource(R.mipmap.ic_launcher_round);
    }

    private void recordService(){
        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference mechanicRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanic").child(userId).child("history");
